...
-(void)endAnimation{
    ...
    _selectBtn = appDelegate.selectBtn ;
    id obj = [tmpDic objectForKey:@"icon"];
    [_selectBtn setBackgroundImage:[UIImage imageNamed:obj] forState:UIControlStateNormal];
    appDelegate.selectBtn = _selectBtn;
